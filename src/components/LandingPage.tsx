            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="mt-3 text-xl text-gray-500 dark:text-gray-400 sm:mt-4">
                  We empower citizens and streamline city services for faster, more transparent resolutions.
                </p>
              </div>
            </div>
            <div className="mt-10 pb-12 bg-white dark:bg-gray-800 sm:pb-16">
                  ...
                  <div className="max-w-4xl mx-auto">
                    <dl className="rounded-lg bg-white dark:bg-gray-800 shadow-lg sm:grid sm:grid-cols-3">
                      <div className="flex flex-col border-b border-gray-100 dark:border-gray-700 p-6 text-center sm:border-0 sm:border-r">
                        <dt className="order-2 mt-2 text-lg leading-6 font-medium text-gray-500 dark:text-gray-400">Issues Resolved</dt>
                        <dd className="order-1 text-5xl font-extrabold text-indigo-600 dark:text-indigo-400">1,500+</dd>
                      </div>
                      <div className="flex flex-col border-t border-b border-gray-100 dark:border-gray-700 p-6 text-center sm:border-0 sm:border-l sm:border-r">
                        <dt className="order-2 mt-2 text-lg leading-6 font-medium text-gray-500 dark:text-gray-400">Citizen Satisfaction</dt>
                        <dd className="order-1 text-5xl font-extrabold text-indigo-600 dark:text-indigo-400">95%</dd>
                      </div>
                      <div className="flex flex-col border-t border-gray-100 dark:border-gray-700 p-6 text-center sm:border-0 sm:border-l">
                        <dt className="order-2 mt-2 text-lg leading-6 font-medium text-gray-500 dark:text-gray-400">Communities Active</dt>
                        <dd className="order-1 text-5xl font-extrabold text-indigo-600 dark:text-indigo-400">42</dd>
                      </div>
                    </dl>
                  </div>
                </div>
